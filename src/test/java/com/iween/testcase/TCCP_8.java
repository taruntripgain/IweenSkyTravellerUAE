...
public class TCCP_8 extends baseClass {
...
//      		resultPage.validateFlightCardSearch(userEnteredData,test);
           ...
           test.log(Status.INFO, "Depart From: " + modifySearchFromLocation +",Going To: "+ modifySearchToLocation+",Selected Class: "+modifyTravelClass);
	        test.log(Status.INFO, "AdultsCounts: " + modifySearchAdultsCounts + ", ChildrenCount: " + modifySearchChildrenCount + ", InfantsCount: " + modifySearchInfantsCount);
      		...
      		String[] userEnteredData1 =resultPage.modifyUserEnteredDetails(test);
      		Thread.sleep(3000);
      	//	resultPage.validateFlightCardSearch(userEnteredData1,test);
      		Thread.sleep(3000);
      		resultPage.selectFlightBasedOnIndexForDetails(FlightCardBasedOnIndex,test);
      		Thread.sleep(5000);
      		flightDetails.validateFlightDetailsBasedOnFlightCard(userEnteredData1, test);
