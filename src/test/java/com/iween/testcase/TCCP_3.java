...
public class TCCP_3 extends baseClass {
    ...
    public void myTest(Map<String, String> excelTestData) throws Exception {
        ...
        try {
   		...
   		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@class='profile-page__content gap-5 p-2']")));
           long endTime1 = System.currentTimeMillis();
   		long loadTimeInSeconds1 = (endTime - startTime) / 1000;
   		test.log(Status.INFO, "Profile  page  loaded in " + loadTimeInSeconds + " seconds");
          
           
           profilePage.validateProfilePageIsDisplayed(test);
